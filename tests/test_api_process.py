...
def test_process_creates_task_and_returns_202(auth_client: TestClient):
    payload = {
        "url": "https://example.com",
        "prompt": "Extract headlines"
    }
    resp = auth_client.post("/api/v1/process", json=payload)
...
def test_process_unauthorized(client: TestClient):
    payload = {
        "url": "https://example.com",
        "prompt": "Extract headlines"
    }
