...
- Тестовые данные - достаточное количество тестовых записей для демонстрации работоспобности приложения и edge cases.
...
- Реализованы ETL или ELT-процессы с инкрементальной загрузкой, контролем ошибок, логированием и отчётами по загрузкам.
